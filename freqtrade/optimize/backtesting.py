...
class Backtesting:
    ...
    def _set_strategy(self, strategy: IStrategy):
        ...
        self._can_short = strategy.can_short
    ...
    def load_bt_data(self) -> tuple[dict[str, DataFrame], TimeRange]:
        ...
        data = history.load_data(
            ...
            fill_up_missing=False if self.config['exchange']['name'] in self.config.get('exchanges_not_fill_missing',[]) else True,
        )
